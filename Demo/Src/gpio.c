...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, IMU_TEMP_Pin|OLED_DC_Pin|GPIO_PIN_2|OLED_RST_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = IMU_TEMP_Pin|OLED_DC_Pin|GPIO_PIN_2|OLED_RST_Pin;
