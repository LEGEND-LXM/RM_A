...
#line 306 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
  ...
  *(volatile uint32_t *)((uint32_t)USBx_BASE + 0xE00UL) = 0U;
  ...
  if (cfg.dma_enable == 1U)
  {
    ...
    ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x800UL))->DTHRCTL = (0x040UL << (2U)) |
                           (0x040UL << (17U));

    ((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x800UL))->DTHRCTL |= (0x1UL << (16U)) |
                            (0x1UL << (1U)) |
                            (0x1UL << (0U));
  }
...
HAL_StatusTypeDef USB_WritePacket(USB_OTG_GlobalTypeDef *USBx, uint8_t *src, uint8_t ch_ep_num, uint16_t len, uint8_t dma)
{
  ...
  if (dma == 0U)
  {
    ...
    {
      *(volatile uint32_t *)(USBx_BASE + 0x1000UL + (((uint32_t)ch_ep_num) * 0x1000UL)) = *((__packed uint32_t *)pSrc);
      pSrc++;
    }
  }
...
HAL_StatusTypeDef  USB_ActivateSetup(USB_OTG_GlobalTypeDef *USBx)
{
  ...
  if ((((USB_OTG_DeviceTypeDef *)(USBx_BASE + 0x800UL))->DSTS & (0x3UL << (1U))) == (2U << 1))
  {
    ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x900UL + ((0U) * 0x20UL)))->DIEPCTL |= 3U;
  }
