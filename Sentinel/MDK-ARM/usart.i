...
void MX_UART8_Init(void)
{
  ...
  huart8.Instance = ((USART_TypeDef *) (0x40000000UL + 0x7C00UL));
  huart8.Init.BaudRate = 115200;
  huart8.Init.WordLength = 0x00000000U;
  huart8.Init.StopBits = 0x00000000U;
  huart8.Init.Parity = 0x00000000U;
  huart8.Init.Mode = ((uint32_t)((0x1UL << (3U)) | (0x1UL << (2U))));
  huart8.Init.HwFlowCtl = 0x00000000U;
  huart8.Init.OverSampling = 0x00000000U;
...
void MX_USART1_UART_Init(void)
{
  ...
  huart1.Init.WordLength = ((uint32_t)(0x1UL << (12U)));
  huart1.Init.StopBits = 0x00000000U;
  huart1.Init.Parity = ((uint32_t)(0x1UL << (10U)));
...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if(uartHandle->Instance==((USART_TypeDef *) (0x40000000UL + 0x7C00UL)))
  {
   

   
     
    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) |= ((0x1UL << (31U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) & ((0x1UL << (31U)))); (void)tmpreg; } while(0U);
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x0002)|((uint16_t)0x0001);
  ...
  else if(uartHandle->Instance==((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL)))
  {
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x0080)|((uint16_t)0x0040);
    GPIO_InitStruct.Mode = 0x00000002U;
    GPIO_InitStruct.Pull = 0x00000001U;
    GPIO_InitStruct.Speed = 0x00000003U;
    ...
    hdma_usart1_rx.Init.Priority = 0x00000000U;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if(uartHandle->Instance==((USART_TypeDef *) (0x40000000UL + 0x7C00UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR &= ~((0x1UL << (31U))));
  
    


 
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), ((uint16_t)0x0002)|((uint16_t)0x0001));
  ...
  else if(uartHandle->Instance==((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0080)|((uint16_t)0x0040));
