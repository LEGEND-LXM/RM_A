...
uint32_t HAL_GetHalVersion(void)
{
  return (((0x01U) << 24U) |((0x07U) << 16U) |((0x05U) << 8U ) |((0x00U)));
}
...
void HAL_EnableMemorySwappingBank(void)
{
  *(volatile uint32_t *)(uint32_t)(0x42000000UL + ((((0x40000000UL + 0x00010000UL) + 0x3800UL) - 0x40000000UL) * 32U) + ((8U) * 4U)) = (uint32_t)ENABLE;
}
...
void HAL_DisableMemorySwappingBank(void)
{
  *(volatile uint32_t *)(uint32_t)(0x42000000UL + ((((0x40000000UL + 0x00010000UL) + 0x3800UL) - 0x40000000UL) * 32U) + ((8U) * 4U)) = (uint32_t)DISABLE;
}
