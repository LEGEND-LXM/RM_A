...
#line 19 "..\\bsp\\bsp_can.c"

moto_info_t motor_info[4];
...
void can_user_init(CAN_HandleTypeDef* hcan )
{
  ...
  can_filter.FilterMode =  (0x00000000U);  
  can_filter.FilterScale = (0x00000001U);
  can_filter.FilterIdHigh = 0;
  can_filter.FilterIdLow  = 0;
  can_filter.FilterMaskIdHigh = 0;
  can_filter.FilterMaskIdLow  = 0;                
  can_filter.FilterFIFOAssignment = (0x00000000U); 
...
void HAL_CAN_RxFifo0MsgPendingCallback(CAN_HandleTypeDef *hcan)
{
  ...
  {
    HAL_CAN_GetRxMessage(hcan, (0x00000000U), &rx_header, rx_data); 
  }
  if ((rx_header.StdId > 0x204) && (rx_header.StdId <  0x204 + 4))
  {
    uint8_t index = rx_header.StdId - 0x204;                  
	...
	if ((rx_header.StdId < 0x204) && (rx_header.StdId >  0x204 - 4))
  {
    uint8_t index = rx_header.StdId - 0x204 + 7;                  
    motor_info[index].rotor_angle    = ((rx_data[0] << 8) | rx_data[1]);
    motor_info[index].rotor_speed    = ((rx_data[2] << 8) | rx_data[3]);
    motor_info[index].torque_current = ((rx_data[4] << 8) | rx_data[5]);
    motor_info[index].temp           =   rx_data[6];
...
void set_motor_voltage(uint8_t id_range, int16_t v1, int16_t v2, int16_t v3, int16_t v4)
{
  ...
  tx_header.IDE   = (0x00000000U);
  tx_header.RTR   = (0x00000000U);
  tx_header.DLC   = 8;
  ...
  tx_data[6] = (v4>>8)&0xff;
  tx_data[7] =    (v4)&0xff;
  HAL_CAN_AddTxMessage(&hcan1, &tx_header, tx_data,(uint32_t*)(0x00000001U)); 
}
