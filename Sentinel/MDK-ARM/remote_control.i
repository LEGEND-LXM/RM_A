...
static void uart_rx_idle_callback(UART_HandleTypeDef* huart)
{
	...
	if (huart == &huart1)
	{
		...
		((huart->hdmarx)->Instance ->CR &= ~(0x1UL << (0U)));

		 
		if (((50) - dma_current_data_counter(huart->hdmarx->Instance)) == (18))
		{
			Callback_RC_Handle(&remote_control, dbus_buf);	
		}
		
		 
		((huart->hdmarx)->Instance ->NDTR = (uint16_t)((50)));
		((huart->hdmarx)->Instance ->CR |= (0x1UL << (0U)));
	}
}
...
{  
	if ((((huart)->Instance ->SR & (((uint32_t)(0x1UL << (4U))))) == (((uint32_t)(0x1UL << (4U))))) && 
			(((((((uint32_t)(1U << 28U | (0x1UL << (4U))))) >> 28U) == 1U)? (huart)->Instance ->CR1:(((((uint32_t)(((uint32_t)(1U << 28U | (0x1UL << (4U)))))) >> 28U) == 2U)? (huart)->Instance ->CR2 : (huart)->Instance ->CR3)) & (((uint32_t)(((uint32_t)(1U << 28U | (0x1UL << (4U)))))) & 0x0000FFFFU)))
	{
...
void dbus_uart_init(void)
{
	...
	((((((uint32_t)(1U << 28U | (0x1UL << (4U))))) >> 28U) == 1U)? ((&huart1)->Instance ->CR1 |= ((((uint32_t)(1U << 28U | (0x1UL << (4U))))) & 0x0000FFFFU)): (((((uint32_t)(1U << 28U | (0x1UL << (4U))))) >> 28U) == 2U)? ((&huart1)->Instance ->CR2 |= ((((uint32_t)(1U << 28U | (0x1UL << (4U))))) & 0x0000FFFFU)): ((&huart1)->Instance ->CR3 |= ((((uint32_t)(1U << 28U | (0x1UL << (4U))))) & 0x0000FFFFU)));

	uart_receive_dma_no_it(&huart1, dbus_buf, (50));
}
