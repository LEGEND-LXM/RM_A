...
#line 401 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pwr_ex.c"
...
HAL_StatusTypeDef HAL_PWREx_EnableOverDrive(void)
{
  ...
  (*(volatile uint32_t *) (uint32_t)(0x42000000UL + ((((0x40000000UL + 0x7000UL) - 0x40000000UL) + 0x00U) * 32U) + ((16U) * 4U)) = ENABLE);

   
  tickstart = HAL_GetTick();

  while(!((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CSR & ((0x1UL << (16U)))) == ((0x1UL << (16U)))))
  {
    if((HAL_GetTick() - tickstart) > 1000U)
    {
      return HAL_TIMEOUT;
  ...
  (*(volatile uint32_t *) (uint32_t)(0x42000000UL + ((((0x40000000UL + 0x7000UL) - 0x40000000UL) + 0x00U) * 32U) + ((17U) * 4U)) = ENABLE);

   
  tickstart = HAL_GetTick();

  while(!((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CSR & ((0x1UL << (17U)))) == ((0x1UL << (17U)))))
  {
    if((HAL_GetTick() - tickstart ) > 1000U)
    {
      return HAL_TIMEOUT;
...
HAL_StatusTypeDef HAL_PWREx_DisableOverDrive(void)
{
  ...
  (*(volatile uint32_t *) (uint32_t)(0x42000000UL + ((((0x40000000UL + 0x7000UL) - 0x40000000UL) + 0x00U) * 32U) + ((17U) * 4U)) = DISABLE);
  ...
  (*(volatile uint32_t *) (uint32_t)(0x42000000UL + ((((0x40000000UL + 0x7000UL) - 0x40000000UL) + 0x00U) * 32U) + ((16U) * 4U)) = DISABLE);
...
HAL_StatusTypeDef HAL_PWREx_EnterUnderDriveSTOPMode(uint32_t Regulator, uint8_t STOPEntry)
{
  ...
  (((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CSR |= (0x3UL << (18U)));
  
    
  (((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR |= (uint32_t)(0x3UL << (18U)));

   
  tmpreg1 = ((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR;
   
  tmpreg1 &= (uint32_t)~((0x1UL << (1U)) | (0x1UL << (0U)) | (0x1UL << (10U)) | (0x1UL << (11U)));
  
   
  tmpreg1 |= Regulator;
  
   
  ((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR = tmpreg1;
