...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1800UL)), ((uint16_t)0x0100)|((uint16_t)0x0080)|((uint16_t)0x0040) 
                          |((uint16_t)0x0020)|((uint16_t)0x0010)|((uint16_t)0x0008)|((uint16_t)0x0004) 
                          |((uint16_t)0x0002), GPIO_PIN_SET);
  
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1800UL)), ((uint16_t)0x2000), GPIO_PIN_SET);
	
   
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1C00UL)), ((uint16_t)0x0004)|((uint16_t)0x0008)|((uint16_t)0x0010)|((uint16_t)0x0020), GPIO_PIN_SET);

   
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), ((uint16_t)0x0010)|((uint16_t)0x0020), GPIO_PIN_SET);

   
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), ((uint16_t)0x0800), GPIO_PIN_RESET);

   
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1400UL)), ((uint16_t)0x4000), GPIO_PIN_RESET);

  

 
  GPIO_InitStruct.Pin = ((uint16_t)0x2000)|((uint16_t)0x0100)|((uint16_t)0x0080)|((uint16_t)0x0040) 
                          |((uint16_t)0x0020)|((uint16_t)0x0010)|((uint16_t)0x0008)|((uint16_t)0x0004) 
                          |((uint16_t)0x0002);
