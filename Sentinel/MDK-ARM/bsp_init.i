...
#line 4 "..\\TASK\\bsp_init.c"
#line 5 "..\\TASK\\bsp_init.c"
...
void hardware_init(void)
{
	HARDCHECK=0;
	GIMBAL_COUNT=0;
	SELFCHECK_param_init(); 
	
	 
	ramp_init(&fric_pwm, 0.01,1150,1000);
