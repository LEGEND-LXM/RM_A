...
__weak uint32_t HAL_RCC_GetSysClockFreq(void)
{
  ...
  switch (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->CFGR & (0x3UL << (2U)))
  {
    ...
    case 0x00000004U:   
    {
      sysclockfreq = ((uint32_t)12000000U);
      break;
    }
    case 0x00000008U:   
    {
      ...
      if(((uint32_t)(((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLCFGR & (0x1UL << (22U)))) != 0x00000000U)
      {
        ...
        pllvco = (uint32_t) ((((uint64_t) ((uint32_t)12000000U) * ((uint64_t) ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLCFGR & (0x1FFUL << (6U))) >> (6U))))) / (uint64_t)pllm);
      }
      else
      {
