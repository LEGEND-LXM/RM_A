...
#line 86 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_exti.c"
...
HAL_StatusTypeDef HAL_EXTI_SetConfigLine(EXTI_HandleTypeDef *hexti, EXTI_ConfigTypeDef *pExtiConfig)
{
  ...
  ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->IMR &= ~pExtiConfig->Line;
  ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->EMR &= ~pExtiConfig->Line;

   
  regval = (uint32_t)((0x40000000UL + 0x00010000UL) + 0x3C00UL);
  regval += pExtiConfig->Mode;
  *(volatile uint32_t *) regval |= pExtiConfig->Line;

   
  ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->RTSR &= ~pExtiConfig->Line;
  ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->FTSR &= ~pExtiConfig->Line;

   
  if (pExtiConfig->Trigger == 0x00000010U)
  {
...
HAL_StatusTypeDef HAL_EXTI_GetConfigLine(EXTI_HandleTypeDef *hexti, EXTI_ConfigTypeDef *pExtiConfig)
{
  ...
  if ((((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->IMR & hexti->Line) == hexti->Line)
  {
    pExtiConfig->Mode = 0x00000000U;
  }
  else if ((((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->EMR & hexti->Line) == hexti->Line)
  {
    pExtiConfig->Mode = 0x00000004U;
  }
  else
  {
  ...
  if ((((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->RTSR & hexti->Line) == hexti->Line)
  {
    if ((((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->FTSR & hexti->Line) == hexti->Line)
    {
      pExtiConfig->Trigger = 0x00000010U;
    }
    else
    {
      pExtiConfig->Trigger = 0x00000008U;
    }
  }
  else if ((((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->FTSR & hexti->Line) == hexti->Line)
  {
    pExtiConfig->Trigger = 0x0000000CU;
  }
  else
  {
...
HAL_StatusTypeDef HAL_EXTI_ClearConfigLine(EXTI_HandleTypeDef *hexti)
{
  ...
  ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->IMR = (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->IMR & ~hexti->Line);

   
  ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->EMR = (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->EMR & ~hexti->Line);

   
  ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->RTSR = (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->RTSR & ~hexti->Line);
  ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->FTSR = (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->FTSR & ~hexti->Line);
...
void HAL_EXTI_IRQHandler(EXTI_HandleTypeDef *hexti)
{
  if (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->PR != 0x00u)
  {
     
    ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->PR = hexti->Line;
...
uint32_t HAL_EXTI_GetPending(EXTI_HandleTypeDef *hexti, uint32_t Edge)
{
  ...
  regaddr = &((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->PR;

   
  regval = ((*regaddr & hexti->Line) >> (__clz(__rbit(hexti->Line))));
...
void HAL_EXTI_GenerateSWI(EXTI_HandleTypeDef *hexti)
{
  ...
  ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->SWIER = hexti->Line;
}
