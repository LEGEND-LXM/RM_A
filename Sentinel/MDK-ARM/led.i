...
void greenled_ctrl_on(uint16_t GPIO_Pin)
{HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1800UL)), GPIO_Pin, GPIO_PIN_RESET);}

void greenled_ctrl_off(uint16_t GPIO_Pin)
{HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1800UL)), GPIO_Pin, GPIO_PIN_SET);}

void single_green_off(void)
{HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1400UL)), ((uint16_t)0x4000), GPIO_PIN_SET);}
