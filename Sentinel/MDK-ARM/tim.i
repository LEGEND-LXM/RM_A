...
void MX_TIM1_Init(void)
{
  ...
  if (HAL_TIM_PWM_ConfigChannel(&htim1, &sConfigOC, 0x0000000CU) != HAL_OK)
  {
    Error_Handler();
  }
...
void MX_TIM12_Init(void)
{
  ...
  htim12.Instance = ((TIM_TypeDef *) (0x40000000UL + 0x1800UL));
  htim12.Init.Prescaler = 1-1;
  htim12.Init.CounterMode = 0x00000000U;
  htim12.Init.Period = 30000-1;
  htim12.Init.ClockDivision = 0x00000000U;
  htim12.Init.AutoReloadPreload = 0x00000000U;
  ...
  sConfigOC.OCPolarity = 0x00000000U;
  sConfigOC.OCFastMode = 0x00000000U;
  if (HAL_TIM_PWM_ConfigChannel(&htim12, &sConfigOC, 0x00000000U) != HAL_OK)
  {
    Error_Handler();
  }
	HAL_TIM_PWM_Start(&htim12, 0x00000000U);
...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef* tim_pwmHandle)
{
  ...
  if(tim_pwmHandle->Instance==((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0000UL)))
  {
  ...
  else if(tim_pwmHandle->Instance==((TIM_TypeDef *) (0x40000000UL + 0x1800UL)))
  {
   

   
     
    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) |= ((0x1UL << (6U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) & ((0x1UL << (6U)))); (void)tmpreg; } while(0U);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  if(tim_baseHandle->Instance==((TIM_TypeDef *) (0x40000000UL + 0x1400UL)))
  {
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  else if(timHandle->Instance==((TIM_TypeDef *) (0x40000000UL + 0x1800UL)))
  {
...
void HAL_TIM_PWM_MspDeInit(TIM_HandleTypeDef* tim_pwmHandle)
{
  ...
  else if(tim_pwmHandle->Instance==((TIM_TypeDef *) (0x40000000UL + 0x1800UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR &= ~((0x1UL << (6U))));
