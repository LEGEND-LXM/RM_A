...
#line 111 "../Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ioreq.h"
...
#line 30 "../Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ctlreq.h"
...
#line 33 "../Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h"
...
#line 31 "../Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ioreq.h"
...
#line 30 "../Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Inc/usbd_cdc.h"
...
#line 80 "../Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Inc/usbd_cdc.h"
...
__align(4) uint8_t USBD_CDC_CfgHSDesc[67U]  =
{
...
__align(4) uint8_t USBD_CDC_CfgFSDesc[67U]  =
{
...
__align(4) uint8_t USBD_CDC_OtherSpeedCfgDesc[67U]  =
{
  0x09,    
  0x07U,
  67U,
...
static uint8_t  USBD_CDC_DataIn (USBD_HandleTypeDef *pdev, uint8_t epnum)
{
  ...
  if(pdev->pClassData != 0)
  {
    if((pdev->ep_in[epnum].total_length > 0U) && ((pdev->ep_in[epnum].total_length % hpcd->IN_ep[epnum].maxpacket) == 0U))
    {
      ...
      USBD_LL_Transmit (pdev, epnum, 0, 0U);
    }
    else
    {
      hcdc->TxState = 0U;
...
static uint8_t  USBD_CDC_EP0_RxReady (USBD_HandleTypeDef *pdev)
{
  ...
  if((pdev->pUserData != 0) && (hcdc->CmdOpCode != 0xFFU))
  {
