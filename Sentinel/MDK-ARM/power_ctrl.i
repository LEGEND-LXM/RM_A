...
void power_ctrl_on(uint8_t num)
{
    ...
    HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1C00UL)),((uint16_t)0x0004) << num,GPIO_PIN_SET);
}
...
void power_ctrl_off(uint8_t num)
{
    ...
    HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1C00UL)),((uint16_t)0x0004) << num,GPIO_PIN_RESET);
}
