#line 1 "..\\MPU6050\\mpu_dmp_useapi.c"
...
#line 45 "..\\MPU6050\\mpu_dmp_useapi.c"
...
#line 46 "..\\MPU6050\\mpu_dmp_useapi.c"
...
#line 47 "..\\MPU6050\\mpu_dmp_useapi.c"
...
#line 48 "..\\MPU6050\\mpu_dmp_useapi.c"
...
#line 49 "..\\MPU6050\\mpu_dmp_useapi.c"
...
#line 51 "..\\MPU6050\\mpu_dmp_useapi.c"
#line 52 "..\\MPU6050\\mpu_dmp_useapi.c"
...
#line 53 "..\\MPU6050\\mpu_dmp_useapi.c"
#line 1 "../Inc/myiic.h"
...
#line 54 "..\\MPU6050\\mpu_dmp_useapi.c"
...
#line 55 "..\\MPU6050\\mpu_dmp_useapi.c"
#line 1 "..\\bsp\\scope.h"
...
#line 56 "..\\MPU6050\\mpu_dmp_useapi.c"
...
#line 57 "..\\MPU6050\\mpu_dmp_useapi.c"
...
#line 58 "..\\MPU6050\\mpu_dmp_useapi.c"
...
uint8_t mpu_dmp_init(void)
{
    ...
    hal.dmp_features = (0x010) | (0x001) |(0x002) | (0x040) | (0x100) |(0x020);
...
short gyro_mpu[3], accel_mpu[3], sensors;			
unsigned char more;							
long quat_mpu[4];								
float pit,rol,yaw;							
...
uint8_t dmp_getdata(void)
{
	...
	if (hal.new_gyro && hal.dmp_on) {
		...
		if(dmp_read_fifo(gyro_mpu, accel_mpu, quat_mpu, &sensor_timestamp, &sensors,&more)){		
			return 1;
		}
		...
		if (sensors & (0x100)){					
			...
			q0 = quat_mpu[0] / 1073741824.0f;
			q1 = quat_mpu[1] / 1073741824.0f;
			q2 = quat_mpu[2] / 1073741824.0f;
			q3 = quat_mpu[3] / 1073741824.0f;
		...
		if(mpu_read_fifo(gyro_mpu, accel_mpu, &sensor_timestamp, &sensors, &more)){				
