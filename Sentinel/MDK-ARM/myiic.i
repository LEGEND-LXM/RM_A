...
void IIC_Init(void)
{
    ...
    GPIO_Initure.Pin=((uint16_t)0x0010)|((uint16_t)0x0020);
    ...
    *((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) &0xFFFFF)<<5)+(5<<2))))=1;
...
void IIC_Start(void)
{
	{((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL))->MODER&=~(3<<(5*2));((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL))->MODER|=1<<5*2;};     
	*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) &0xFFFFF)<<5)+(5<<2))))=1;	  	  
	*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) &0xFFFFF)<<5)+(4<<2))))=1;
	TIM7_Delay_Us(4);
 	*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) &0xFFFFF)<<5)+(5<<2))))=0;
	TIM7_Delay_Us(4);
...
{
	uint8_t ucErrTime=0;
	{((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL))->MODER&=~(3<<(5*2));((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL))->MODER|=0<<5*2;};      
	*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) &0xFFFFF)<<5)+(5<<2))))=1;TIM7_Delay_Us(1);	   
	*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) &0xFFFFF)<<5)+(4<<2))))=1;TIM7_Delay_Us(1);	 
	while(*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0000UL)+16) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0000UL)+16) &0xFFFFF)<<5)+(5<<2)))))
	{
		ucErrTime++;
		if(ucErrTime>250)
		{
...
{                        
    ...
    *((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) &0xFFFFF)<<5)+(4<<2))))=0;
    for(t=0;t<8;t++)
    {              
        *((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) &0xFFFFF)<<5)+(5<<2))))=(txd&0x80)>>7;
        txd<<=1; 	  
		TIM7_Delay_Us(2);   
		*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) &0xFFFFF)<<5)+(4<<2))))=1;
		TIM7_Delay_Us(2); 
...
uint8_t IIC_Read_Byte(unsigned char ack)
{
    ...
    for(i=0;i<8;i++ )
	{
		...
		*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) &0xFFFFF)<<5)+(4<<2))))=1;
        receive<<=1;
        if(*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0000UL)+16) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0000UL)+16) &0xFFFFF)<<5)+(5<<2)))))receive++;   
		TIM7_Delay_Us(1); 
    }					 
    if (!ack)
        IIC_NAck();
