...
#line 120 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_flash_ex.c"
  ...
  if(status == HAL_OK)
  {
    ...
    *SectorError = 0xFFFFFFFFU;
    ...
    if(pEraseInit->TypeErase == 0x00000001U)
    {
      ...
      ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR &= (~((0x1UL << (2U)) | (0x1UL << (15U))));
    }
    else
    {
...
HAL_StatusTypeDef HAL_FLASHEx_AdvOBProgram (FLASH_AdvOBProgramInitTypeDef *pAdvOBInit)
{
  ...
  if(((pAdvOBInit->OptionType) & 0x00000002U) == 0x00000002U)
  {
...
void HAL_FLASHEx_AdvOBGetConfig(FLASH_AdvOBProgramInitTypeDef *pAdvOBInit)
{
#line 438 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_flash_ex.c"
   
  pAdvOBInit->SectorsBank1 = (*(volatile uint16_t *)(0x40023C16U));

   
  pAdvOBInit->SectorsBank2 = (*(volatile uint16_t *)(0x40023C1AU));

   
  pAdvOBInit->BootConfig = *(volatile uint8_t *)0x40023C14U;
...
{                            
  ...
  return (*(volatile uint16_t *)(0x40023C1AU));
}
...
static void FLASH_MassErase(uint8_t VoltageRange, uint32_t Banks)
{
  ...
  else
  {
    ...
    ((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR |= (0x1UL << (15U));
  }
...
static HAL_StatusTypeDef FLASH_OB_EnableWRP(uint32_t WRPSector, uint32_t Banks)
{
  ...
  if(status == HAL_OK)
  {
    if(((WRPSector == 0x00000FFFU << 12U) && ((Banks == 1U) || (Banks == ((uint32_t)1U | 2U)))) ||
         (WRPSector < 0x00000001U << 12U))
    {
       if(WRPSector == 0x00000FFFU << 12U)
       {
           
          *(volatile uint16_t*)0x40023C16U &= (~(WRPSector>>12));  
       }
       else
       {
    ...
    else 
    {
      ...
      *(volatile uint16_t*)0x40023C1AU &= (~(WRPSector>>12));  
    }

     
    if((WRPSector == 0x00000FFFU << 12U) && (Banks == ((uint32_t)1U | 2U)))
    {
  ...
  if(status == HAL_OK)
  {
         ...
         (WRPSector < 0x00000001U << 12U))
    {
       if(WRPSector == 0x00000FFFU << 12U)
       {
          ...
          *(volatile uint16_t*)0x40023C16U |= (uint16_t)(WRPSector>>12); 
       }
       else
       {
    ...
    else 
    {
      ...
      *(volatile uint16_t*)0x40023C1AU |= (uint16_t)(WRPSector>>12); 
    }
...
static HAL_StatusTypeDef FLASH_OB_BootConfig(uint8_t BootConfig)
{
  ...
  { 
    ...
    *(volatile uint8_t *)0x40023C14U &= (~(0x1UL << (4U)));
    *(volatile uint8_t *)0x40023C14U |= BootConfig;
  }
...
static HAL_StatusTypeDef FLASH_OB_EnablePCROP(uint32_t SectorBank1, uint32_t SectorBank2, uint32_t Banks)
{
  ...
  if(status == HAL_OK)
  {
    if((Banks == 1U) || (Banks == ((uint32_t)1U | 2U)))
    {
      ((void)0U);
       
      *(volatile uint16_t*)0x40023C16U |= (uint16_t)SectorBank1; 
    }
    else 
    {
      ((void)0U);
       
      *(volatile uint16_t*)0x40023C1AU |= (uint16_t)SectorBank2; 
    }
...
{  
  ...
  if(status == HAL_OK)
  {
    if((Banks == 1U) || (Banks == ((uint32_t)1U | 2U)))
    {
      ...
      *(volatile uint16_t*)0x40023C16U &= (~SectorBank1); 
    }
    else 
    {
       
      ((void)0U);
      *(volatile uint16_t*)0x40023C1AU &= (~SectorBank2); 
    }
...
#line 1088 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_flash_ex.c"

#line 1149 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_flash_ex.c"
