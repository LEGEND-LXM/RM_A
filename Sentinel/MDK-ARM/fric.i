...
{
    HAL_TIM_PWM_Start(&htim1, 0x00000000U); 
    HAL_TIM_PWM_Start(&htim1, 0x0000000CU);

		ramp_calc(&fric_pwm,1000);
	  (((0x00000000U) == 0x00000000U) ? ((&htim1)->Instance ->CCR1 = (fric_pwm . out)) : ((0x00000000U) == 0x00000004U) ? ((&htim1)->Instance ->CCR2 = (fric_pwm . out)) : ((0x00000000U) == 0x00000008U) ? ((&htim1)->Instance ->CCR3 = (fric_pwm . out)) : ((&htim1)->Instance ->CCR4 = (fric_pwm . out)));
    (((0x0000000CU) == 0x00000000U) ? ((&htim1)->Instance ->CCR1 = (fric_pwm . out)) : ((0x0000000CU) == 0x00000004U) ? ((&htim1)->Instance ->CCR2 = (fric_pwm . out)) : ((0x0000000CU) == 0x00000008U) ? ((&htim1)->Instance ->CCR3 = (fric_pwm . out)) : ((&htim1)->Instance ->CCR4 = (fric_pwm . out)));
		 
		HAL_Delay(4000);
		(((0x00000000U) == 0x00000000U) ? ((&htim1)->Instance ->CCR1 = (1000)) : ((0x00000000U) == 0x00000004U) ? ((&htim1)->Instance ->CCR2 = (1000)) : ((0x00000000U) == 0x00000008U) ? ((&htim1)->Instance ->CCR3 = (1000)) : ((&htim1)->Instance ->CCR4 = (1000)));
			(((0x0000000CU) == 0x00000000U) ? ((&htim1)->Instance ->CCR1 = (1000)) : ((0x0000000CU) == 0x00000004U) ? ((&htim1)->Instance ->CCR2 = (1000)) : ((0x0000000CU) == 0x00000008U) ? ((&htim1)->Instance ->CCR3 = (1000)) : ((&htim1)->Instance ->CCR4 = (1000)));
		HAL_Delay(4000);
}
...
{
	switch(tim_channel){	
		case 0x00000000U: tim->Instance->CCR1 =duty;break;
		case 0x0000000CU: tim->Instance->CCR4 =duty;break;
	}
}
	
void fric_off(void)
{
    PWM_SetDuty(&htim1,0x00000000U,1000);
    PWM_SetDuty(&htim1,0x0000000CU,1000);
}
void fric1_on(uint32_t cmd1)
{
    PWM_SetDuty(&htim1,0x00000000U,cmd1);
}
void fric2_on(uint32_t cmd2)
{
    PWM_SetDuty(&htim1,0x0000000CU,cmd2);
}
