#line 1 "..\\bsp\\Robomaster_Control.c"
...
void task(void);
#line 2 "..\\bsp\\Robomaster_Control.c"
...
#line 3 "..\\bsp\\Robomaster_Control.c"
...
#line 4 "..\\bsp\\Robomaster_Control.c"
...
void task(void)
{
	...
	{SYSTEM_STATION=2; buzzer_on(0, 20000);}
	else
	{SYSTEM_STATION=1;buzzer_off();}	
	...
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1800UL)), ((uint16_t)0x0100)|((uint16_t)0x0080)|((uint16_t)0x0040) 
	                     ...
	                     |((uint16_t)0x0002), GPIO_PIN_RESET);

	
	    if (remote_control.switch_left==0){SYSTEM_STATION=2;}
			else if(remote_control.switch_left==1){SYSTEM_STATION=7;} 
			else if(remote_control.switch_left==3){SYSTEM_STATION=4;} 
			else if(remote_control.switch_left==2){SYSTEM_STATION=6;}
					
			
			switch ( SYSTEM_STATION )            
      {
					 case 2:      offline_control(); break; 
					 case 7: offline_control(); break; 
					 case 4: manual_control(); break; 

					 case 6:   moto_control(); break;				
					 default: break;  
      }
