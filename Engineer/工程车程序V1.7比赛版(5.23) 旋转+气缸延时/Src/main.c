...
extern u8 footstep_flag;
extern u8 footstep_target_flag;
extern u32 tim;
int main(void)
{
...
//		wave_form_data[0] =(short)motor_pid[4].target;//外环目标
//	  wave_form_data[1] =(short)moto_chassis[4].total_angle;//外环实际
//	  wave_form_data[2] =(short)motor_pid[4].output;//内环目标
//	  wave_form_data[3] =(short)moto_chassis[4].angle;//内环实际chassis_yaw.target
//	  wave_form_data[4] =(short)motor_pid[4].output;
//		wave_form_data[5] =(short)footstep_flag;

//键盘鼠标控制
//		wave_form_data[0] =(short)chassis_yaw.target;//外环目标
//	  wave_form_data[1] =(short)imu.yaw;//外环实际
//	  wave_form_data[2] =(short)-imu.gz;//内环目标
//	  wave_form_data[3] =(short)moto_chassis[4].angle;//内环实际chassis_yaw.target
//	  wave_form_data[4] =(short)chassis_yaw_speed.output;
//		wave_form_data[5] =(short)remote_control.mouse.x;
//		wave_form_data[0] =(short)tim;
