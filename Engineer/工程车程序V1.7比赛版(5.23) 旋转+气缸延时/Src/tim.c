...
TIM_OC_InitTypeDef tim8_pwm_conf;
/* TIM1 init function */
...
{
	TIM_ClockConfigTypeDef sClockSourceConfig;
//  	TIM_IC_InitTypeDef htim3cnf;
	htim3.Instance=TIM3;
	htim3.Init.CounterMode=TIM_COUNTERMODE_UP;
	htim3.Init.ClockDivision=TIM_CLOCKDIVISION_DIV1;
	htim3.Init.Prescaler=84-1;//1M
	htim3.Init.Period=20000-1;//20000/1000000
...
void MX_TIM8_Init(void){
	...
	//PI6    ------> TIM8_CH2 X
  //PI5    ------> TIM8_CH1 W
	GPIO_InitTypeDef gpio_PI6;
	gpio_PI6.Pin=GPIO_PIN_7|GPIO_PIN_6|GPIO_PIN_5;
	gpio_PI6.Mode=GPIO_MODE_AF_PP;
	gpio_PI6.Pull=GPIO_NOPULL;
	gpio_PI6.Speed=GPIO_SPEED_FREQ_LOW;
	gpio_PI6.Alternate=GPIO_AF3_TIM8;
	HAL_GPIO_Init(GPIOI,&gpio_PI6);
	...
	htim8.Init.Period=20000-1;   //1ms 1000-2000 2ms
...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef *htim){
	if(htim->Instance==TIM8){
		...
		tim8_pwm_conf.OCPolarity=TIM_OCPOLARITY_HIGH;
		tim8_pwm_conf.OCMode=TIM_OCMODE_PWM1;
		tim8_pwm_conf.OCFastMode = TIM_OCFAST_DISABLE;
		tim8_pwm_conf.Pulse=999;
		HAL_TIM_PWM_ConfigChannel(&htim8,&tim8_pwm_conf,TIM_CHANNEL_2);
		HAL_TIM_PWM_ConfigChannel(&htim8,&tim8_pwm_conf,TIM_CHANNEL_1);
	}
}
/////////////////////////////////////////////////////////////////////////////
