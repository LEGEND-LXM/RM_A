...
//	moto_ctr[6]=remote_control.ch4;
	 ...
	 motor_pid[0].target=moto_ctr[0]*6000/660;
   motor_pid[1].target=moto_ctr[1]*6000/660;
   motor_pid[2].target=moto_ctr[2]*6000/660;
   motor_pid[3].target=moto_ctr[3]*6000/660;
//	 motor_pid[4].target=moto_ctr[4]*6000/660;
//	 motor_pid[5].target=moto_ctr[5]*6000/660;
//	 motor_pid[6].target=moto_ctr[6]*6000/660;
